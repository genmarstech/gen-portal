...
def operations_urls(enquiry: Enquiry, reference: str = "GM-2026-0001") -> list[str]:
    ...
    return [
        ...
        reverse("ops-client-admin", args=[1]),
        ...
        reverse("ops-request", args=[1]),
        reverse("ops-contact-attachments", args=[1]),
        reverse("ops-attachment", args=[1]),
        reverse("ops-client-orders", args=[1]),
        ...
        reverse("ops-tickets"),
        reverse("ops-changes"),
        reverse("ops-change-classify", args=["GM-CR-2026-0001"]),
        reverse("ops-change-close", args=["GM-CR-2026-0001"]),
        ...
        reverse("ops-docs"),
        reverse("ops-work"),
        reverse("ops-work-item", args=[1]),
        reverse("ops-doc", args=[1]),
        reverse("ops-sign-on"),
