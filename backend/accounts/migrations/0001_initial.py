...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('purpose', models.CharField(choices=[('verify', 'Verify email'), ('reset', 'Password reset')], max_length=16)),
            ...
            options={
                'indexes': [models.Index(fields=['user', 'purpose', 'used_at'], name='accounts_em_user_id_7e5813_idx')],
            },
        ),
        migrations.CreateModel(
            name='Membership',
